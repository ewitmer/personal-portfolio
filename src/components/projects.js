  ...
  render() {
    ...
    <div className="Projects-container">
        <a href='https://ewitmer.github.io/openow/' target="_blank" className="project-contents">
            ...
            <div className="github"><a href="https://github.com/ewitmer/openow">view on github</a></div>
        </a>
        ...
        <a href='https://ancient-plateau-51106.herokuapp.com/' target="_blank" className="project-contents">
            ...
            <div className="github"><a href="https://github.com/ewitmer/book_suggestion">view on github</a></div>
        </a>
        ...
        <a href='https://serene-depths-10277.herokuapp.com/' target="_blank" className="project-contents">
            ...
            <div className="github"><a href="https://github.com/ewitmer/bright_night" >view on github</a></div>
        </a>
    </div>
    );
  }
